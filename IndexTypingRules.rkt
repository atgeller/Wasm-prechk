...
(define-judgment-form WASMIndexTypes
  ...
  [(where C_2 (in-label C_1 ticond_1))
   (⊢ C_2 (e ...) (ticond_3 -> ((ti_2 ...) locals_2 Γ_4 φ_4)))
   (<: (ticond_3 -> ((ti_2 ...) locals_2 Γ_4 φ_4))
       (ticond_1 -> ((ti_2 ...) locals_2 Γ_2 φ_2)))
   ----------------------------------------------- "Block"
   (⊢ C_1 ((block (ticond_1 -> ((ti_2 ...) locals_2 Γ_2 φ_2)) (e ...)))
      (ticond_1 -> ((ti_2 ...) locals_2 (union Γ_2 Γ_4) (union φ_2 φ_4))))]
  ...
  [(where C_2 (in-label C_1 ticond_1))
   ...
   (<: (ticond_3 -> ((ti_2 ...) locals_2 Γ_4 φ_4))
       (ticond_1 -> ((ti_2 ...) locals_2 Γ_2 φ_2)))
   ------------------------------------------------ "Loop"
   (⊢ C_1 ((loop (ticond_1 -> ((ti_2 ...) locals_2 Γ_2 φ_2)) (e ...)))
      (ticond_1 -> ((ti_2 ...) locals_2 (union Γ_2 Γ_4) (union φ_2 φ_4))))]

  [(where C_2 (in-label C_1 ((ti_2 ...) locals_2 Γ_2 φ_2)))
   (⊢ C_2 (e_1 ...) (((ti_1 ...) locals_1 Γ_3 (φ_3 (not (= a (i32 0)))))
                     -> ((ti_2 ...) locals_2 Γ_4 φ_4)))
   (⊢ C_2 (e_2 ...) (((ti_1 ...) locals_1 Γ_3 (φ_3 (= a (i32 0))))
                     -> ((ti_2 ...) locals_2 Γ_4 φ_4)))
   (<: (((ti_1 ...) locals_1 Γ_3 φ_3) -> ((ti_2 ...) locals_2 Γ_4 φ_4))
       (((ti_1 ...) locals_1 Γ_1 φ_1) -> ((ti_2 ...) locals_2 Γ_2 φ_2)))
   --------------------------------------------------------------------- "If"
   (⊢ C_1 ((if (((ti_1 ...) locals_1 Γ_1 φ_1) -> ((ti_2 ...) locals_2 Γ_2 φ_2)) (e_1 ...) (e_2 ...)))
      (((ti_1 ... (i32 a)) locals_1 Γ_1 φ_1) -> ((ti_2 ...) locals_2 (union Γ_2 Γ_4) (union φ_2 φ_4))))]
  ...
  [(side-condition (satisfies (union Γ Γ_1) φ_1 φ))
   ------------------------------- "Return"
   (⊢ (_ _ _ _ _ _ (return ((ti ...) _ Γ φ)))
      ((return))
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  [(where (((ti_1 ...) _ Γ φ) -> ((ti_2 ...) _ Γ_2 φ_2)) (do-get (tfi ...) j))
   (side-condition (satisfies (union Γ_1 Γ) φ_1 φ))
  ...
  [(where (((ti_1 ...) _ Γ_1 φ_1)
   ...
   (⊢ (_ _ (table j _) _ _ _ _)
      ...
      (((ti_1 ... (i32 a)) locals_1 Γ_1 φ_1)
       -> ((ti_2 ...) locals_1 Γ_3 φ_3)))]
  
  [(where (((ti_1 ...) _ Γ φ) -> ((ti_2 ...) _ Γ_2 φ_2)) tfi_2)
   (side-condition (satisfies (union Γ_1 Γ) φ_1 φ))
   (where φ_3 (union φ_1 φ_2))
   (where Γ_3 (union Γ_1 Γ_2))
   (side-condition (valid-table-call tfi_2 a (tfi ...) Γ_1 φ_1))
