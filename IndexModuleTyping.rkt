...
(define-judgment-form WASMIndexTypes
  ...
  [(where ((((t_1 a) ...) () globals_1 φ_1) -> ((ti_2 ...) () globals_2 φ_2)) tfi)
   (⊢ ((func (tfi_1 ...)) (global (tg ...)) (table (j_1 (i ...)) ...) (memory j_2 ...) (local (t_1 ... t ...)) (label (((ti_2 ...) _ globals_2 φ_2))) (return ((ti_2 ...) _ globals_2 φ_2)))
      (e ...)
      ((() ((t_1 a) ... (t _) ...) globals_1 φ_1) -> ((ti_2 ...) _ globals_2 φ_2)))
   --------------------------------------------------------------------------------
   (⊢-module-func ((func (tfi_1 ...)) (global (tg ...)) (table (j_1 (i ...)) ...) (memory j_2 ...) _ _ _)
...
(define-judgment-form WASMIndexTypes
  ...
  [(where (mut? t) tg)
   ...
   (⊢ C (e ...) ((() () globals_1 φ_1) -> ((t a) () globals_2 φ_2)))
   -------------------------
   (⊢-module-global C
                    ((ex ...) (global tg (e ...)))
                    ((ex ...) tg))]
